...
const InfyNft = () => {
  ...
  return (
    <div className="font-interfont">
      <div className="relative mx-auto pt-4 flex flex-col items-center justify-center text-[#D2DADF] bg-[url('/assets/nft/infynft/gradient.svg')] bg-cover h-[90vh] overflow-y-auto">
        <div className="flex max-w-7xl w-full flex-col gap-10 md:gap-20 px-5 xl:px-0 py-10 h-full">
          <div className="flex flex-col gap-5 md:gap-[20px]">
              ...
              {trendingTokens?.length === 0 ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-[24px] place-items-center">
                  {trendingTokens?.map((token, index) => (
                    <div className="flex min-w-[262px] md:w-full flex-col items-center justify-center gap-5 rounded-[10px] border border-[#2F3548] p-3">
                      <Link
                        key={index}
                      ...
                      <div className="flex items-center justify-center gap-4 w-full">
                        <Link
                          ...
                          href={`/detailtoken?token=${token.address}`}
                        >
                          <div className="flex items-center justify-center rounded p-0.5 text-sm font-semibold text-[#5EE616] hover:text-[#FDFBFB] w-fit mx-auto">
                            <Button size="sm" className='w-[100px] bg-[#161616] text-thite border border-white hover:bg-transparent'>
            ...
            <div className="w-full p-6 text-center">
              <Button size="sm" className='w-[200px] bg-[#161616] text-thite border-2 border-white hover:bg-transparent' onClick={() => router.push("/alltokens?page=1&limit=10&order=desc&sortBy=market_cap")}>View all</Button>
            </div>
          </div>
        </div>
      </div>
